...
//Precondicion: Tiene que existir al menos una posicion libre en la secuencia.
...
//Devuelve true si el string ya pertenece a la secuencia
...
//Inserta un nuevo elemento al final de la secuencia
//Precondicion: Tiene que existir al menos una posicion libre en la secuencia.
void InsBack (Ciudades &ad, String elemento);

//Listar número y nombre de cada una de las ciudades registradas hasta el momento en el sistema,
//ordenadas por número de ciudad de menor a mayor.
void Listar(Ciudades ad);

//Liberar memoria de los strings de todas las ciudades de le secuencia
