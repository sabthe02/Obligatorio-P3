...
{
    ///Se corrigio estaba definido una variable local de tipo Ciudades
    ///Se controla primero que tengamos lugares libres antes de preguntar el nombre de la ciudad
